...
import { CreateBlog } from "./CeaterBlogerPage";
...
const CreateBloger = () => {
  ...
  const handleCreate = () => {
    ...
    if (name.length >= 20) {
      setIsFailed(true);
      setIsFailedError("bloger name too long");
    } else if (
      directoryList.some(
        (name) =>
      ...
      setIsFailed(true);
      setIsFailedError("found Bloger with the same name");
    } else if (name.length <= 5) {
      setIsFailed(true);
      setIsFailedError("Bloger name too short");
      ...
      setIsFailed(true);
      setIsFailedError("Provide your bloger profile image");
    } else if (more && !image2) {
      setIsFailed(true);
      setIsFailedError("Provide your bloger cover image");
    } else {
      ...
      setShowNotif(true);
      setCreated(true);
      setCreatedSuccessful("Bloger Created successfully");
    }
  };
      ...
      >
        <ScrollView>
          <BackgroundImages
            image={image}
            image2={image2}
            onPressImage={() => CreateBlog.pickImage(setImage, setImage1)}
            onPressImage2={() => CreateBlog.pickImage(setImage2, setImage3)}
          />
